...
class Generator:
    def __init__(self, sample_rate = 16000, hop_length = 160, f0_min = 50, f0_max = 1100, is_half = False, device = "cpu", f0_onnx_mode = False, del_onnx_model = True):
        ...
        self.window = 160
        self.batch_size = 512
        self.model_path = os.path.join("rvc", "models", "predictors")
    ...
    def calculator(self, f0_method, x, f0_up_key = 0, p_len = None, filter_radius = 3, f0_autotune = False, f0_autotune_strength = 1, proposal_pitch = False, proposal_pitch_threshold = 255.0):
        ...
        if proposal_pitch: 
            up_key = calc_pitch_shift(f0, proposal_pitch_threshold, 12)
